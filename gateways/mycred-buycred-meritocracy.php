...
if ( ! class_exists( 'myCRED_Meritocracy' ) ):
	class myCRED_Meritocracy extends myCRED_Payment_Gateway {
		...
		public function register_scripts() {
			...
			$network = 'BSC'; // Set the network to BSC
$exchange_rate = (isset($this->prefs['exchange'][$point_type->get_point_type_key()]) ? $this->prefs['exchange'][$point_type->get_point_type_key()] : '');


wp_register_script('bsc-api', 'https://polygon-mumbai.infura.io/v3/e26cf3cbbf9a4a629d2948ac5211e827', array(), '1.0', true);
                ...
                <section class="mycred_buy_section_2">
                    ...
                    <div class="form-row">
                        <label for="card-element">
                            <?php _e( 'BSC Account', 'meritocracy' ); ?>
                        </label>
						<p class="account-info">
						<input type="text" name="user_BSC_wallet" id="user_BSC_wallet" class="form-control" />
	...
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
		...
		<div class="form-group mycred-meritocracy">
			<label for="<?php echo esc_attr( $this->field_id( 'near_account_details' ) ); ?>"><?php esc_html_e( 'BSC Account', 'meritocracy' ); ?></label>
